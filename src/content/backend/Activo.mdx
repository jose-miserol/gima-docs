...
El modelo `Activo` representa los activos físicos gestionados por el sistema GIMA. Define las relaciones con los artículos del catálogo, las ubicaciones y los historiales de mantenimiento.
