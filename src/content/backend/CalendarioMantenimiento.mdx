# Modelo: CalendarioMantenimiento

Este modelo gestiona la programación de mantenimientos preventivos y correctivos, permitiendo asignar técnicos y establecer fechas programadas.
