# Modelo: SesionesMantenimiento

Representa las jornadas de trabajo individuales dentro de una orden de mantenimiento, registrando horas trabajadas, costos y repuestos utilizados.
