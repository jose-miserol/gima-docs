...
El modelo `Reporte` permite a los usuarios notificar fallas o necesidades de mantenimiento sobre los activos. Es el punto de partida para la creación de órdenes de mantenimiento.
